...
```{r average proportion, response category across location by state, warning = FALSE, fig.height = 10, fig.align = "center"}
library(patchwork)
...
```{r items ordered in each aisle, fig.height = 15, fig.align = "center"}
numb_orders %>% 
