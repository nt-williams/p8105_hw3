...
Figure 3 shows the number of orders across all aisles, order from least to most. Fresh vegetables and fresh fruits are ordered most with 150609 and 150473 orders respectively. Followed by packaged vegetables and fruits. The least ordered items are those coming from the beauty aisle, 287 orders.
